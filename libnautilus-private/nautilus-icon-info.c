...
nautilus_get_icon_size_for_zoom_level (NautilusZoomLevel zoom_level)
{
	...
	case NAUTILUS_ZOOM_LEVEL_SPECIAL1:
		return NAUTILUS_ICON_SIZE_SPECIAL1;
	case NAUTILUS_ZOOM_LEVEL_SPECIAL2:
		return NAUTILUS_ICON_SIZE_SPECIAL2;
	case NAUTILUS_ZOOM_LEVEL_SPECIAL3:
		return NAUTILUS_ICON_SIZE_SPECIAL3;
	case NAUTILUS_ZOOM_LEVEL_SPECIAL4:
		return NAUTILUS_ICON_SIZE_SPECIAL4;
	case NAUTILUS_ZOOM_LEVEL_SPECIAL5:
		return NAUTILUS_ICON_SIZE_SPECIAL5;
	case NAUTILUS_ZOOM_LEVEL_SPECIAL6:
		return NAUTILUS_ICON_SIZE_SPECIAL6;
	case NAUTILUS_ZOOM_LEVEL_SPECIAL7:
		return NAUTILUS_ICON_SIZE_SPECIAL7;
	case NAUTILUS_ZOOM_LEVEL_SPECIAL8:
		return NAUTILUS_ICON_SIZE_SPECIAL8;
	case NAUTILUS_ZOOM_LEVEL_SPECIAL9:
		return NAUTILUS_ICON_SIZE_SPECIAL9;
